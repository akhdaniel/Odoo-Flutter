...
class Body extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    {'name':'RFQ', 'route':'/purchaseOrder/draft', 'icon': Icons.public, 'iconColor': Colors.red[300]},
    {'name':'Purchase Order','route':'/purchaseOrder/confirmed',  'icon': Icons.shopping_basket, 'iconColor': Colors.orange[300]},
    {'name':'Vendors', 'route':'/partner/vendor', 'icon': Icons.account_balance, 'iconColor': Colors.purple[300]},
    {'name':'Receiving','route':'/picking/receiving',  'icon': Icons.warehouse, 'iconColor': Colors.blue[300]},
    {'name':'Bills','route':'/invoice/bill',  'icon': Icons.money, 'iconColor': Colors.green[300]},
  ];
    return SafeArea(
      child: Padding(
