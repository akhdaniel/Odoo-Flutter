...
class Body extends StatelessWidget {
  ...
  //   {'name':'RFQ', 'route':'/Invoice/draft', 'icon': Icons.public, 'iconColor': Colors.red[300]},
  //   {'name':'Purchase Order','route':'/Invoice/confirmed',  'icon': Icons.shopping_basket, 'iconColor': Colors.orange[300]},
