...
class Body extends StatelessWidget {
  ...
  //   {'name':'RFQ', 'route':'/Location/draft', 'icon': Icons.public, 'iconColor': Colors.red[300]},
  //   {'name':'Purchase Order','route':'/Location/confirmed',  'icon': Icons.shopping_basket, 'iconColor': Colors.orange[300]},
